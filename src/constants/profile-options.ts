/**
 * @fileoverview This file contains predefined options for the user profile form.
 */
...
export const treatmentOptions = [
    ...
    "Antihypertenseurs (ARA II)",
    "Bêta-bloquants",
    "Inhibiteurs calciques",
    "Diurétiques",
    "Anticoagulants (AVK - Warfarine)",
    "Anticoagulants (AOD - Rivaroxaban, Apixaban)",
    "Antiagrégants plaquettaires (Aspirine)",
    "Antiagrégants plaquettaires (Clopidogrel)",
    "Statines (anticholestérol)",
    "Fibrates",
    ...
    "Paracétamol (régulièrement)",
    "Anti-inflammatoires non stéroïdiens (AINS)",
    "Opioïdes faibles (Tramadol, Codéine)",
    ...
    "Antiépileptiques",
    "Antiparkinsoniens",
    "Traitement de la migraine (triptans)",
    ...
    "Suppléments de fer",
    "Antiviraux",
    "Antibiotiques (traitement prolongé)",
];

export const additionalSymptomOptions = [
    // Symptômes généraux
    "Fièvre",
    "Frissons",
    "Fatigue intense",
    ...
    "Langue douloureuse",
    "Langue blanche / Chargée",
    "Goût métallique",
    "Perte du goût (agueusie)",
    "Dents sensibles au chaud/froid",
    "Dents qui bougent",
    "Abcès dentaire",
